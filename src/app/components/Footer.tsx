      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              {/* <li><Link href="/contact" className="text-gray-300 hover:text-blue-400 transition-colors">{navigation.contact}</Link></li> */}
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 pt-6 text-center">
          <p className="text-gray-400 text-xs">
            &copy; {new Date().getFullYear()} {content.common.siteName}. {footer.rights}<span>| Designed by</span> <span className="text-gray-300 mt-2">{footer.designedBy}</span>
          </p>
        </div>
      </div>
    </footer>
